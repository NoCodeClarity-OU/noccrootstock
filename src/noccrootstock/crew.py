...
from noccrootstock.tools.custom_tool import ProjectSetupTool, FrontendTool, BackendTool, SmartContractTool, TestingTool, IntegrationTool

@CrewBase
class NoccrootstockCrew():
    """Noccrootstock crew"""
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the Noccrootstock crew"""
        return Crew(
            agents=self.agents,
            tasks=self.tasks,
